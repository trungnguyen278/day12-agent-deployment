...
```bash
# Basic vs Advanced (số đo thật trên máy build)
docker images | grep agent
# agent-develop     1.66 GB  ← python:3.11 full, single-stage
# agent-production   236 MB  ← python:3.11-slim, multi-stage (~86% nhỏ hơn)
```
